/*   STEP 1   */
export const leagueID = "781880478381768704"; // your league ID
export const leagueName = "Diners, Dynasties and Dives"; // your league name
...
export const managers = [
    {
      ...
      "name": "Tyler Gosselin",
      "location": "Durham, ME", // (optional)
      "bio": "@mothergoosey24 (207)624-1387",
      ...
      "rival": {
        name: "Tyler Moody", // Can be anything (usually your rival's name)
        link: 10, // manager array number within this array, or null to link back to all managers page
        image: "/managers/chadwick.jpg", // either a specific manager photo or '/managers/everyone.png' or '/managers/question.png'
      },
      ...
      "philosophy": "Win now, but also win later",
      "tradingScale": 9, // 1 - 10
    ...
    },
    {
      ...
      "rival": {
        name: "Tyler Gosselin", // Can be anything (usually your rival's name)
    ...
    },
    {
      ...
      "mode": "Win Now", // (optional) 'Win Now', 'Dynasty', or 'Rebuild' (anything else and you will need to add a new png to /static/ similar to the 'Rebuild.png' and 'Win Now.png' currently in there)
      "rival": {
        name: "Parker O'Brien", // Can be anything (usually your rival's name)
      ...
      "favoritePlayer": 1958, // (optional) this corresponds to the Sleeper player ID (https://api.sleeper.app/v1/players/nfl)
      "valuePosition": "RB", // (optional) Favorite position (QB, WR, RB, TE, etc.)
    ...
    },
    {
      ...
      "name": "Dustin Dang",
      "location": "Gardiner, ME", // (optional)
      "bio": "@dangitsdustin19 (207)620-4062",
      "photo": "/managers/dustin.jpg", // square ratio recommended (no larger than 500x500)
      ...
      "valuePosition": "WR", // (optional) Favorite position (QB, WR, RB, TE, etc.)
      "rookieOrVets": "Vets", // (optional) 'Rookies' or 'Vets' (anything else and you will need to add a new png to /static/ similar to the 'Rookies.png' and 'Vets.png' currently in there)
      "philosophy": "Ass, gas or grass, nobody rides for free.",
      "tradingScale": 6, // 1 - 10
      "preferredContact": "Sleeper", // 'Text', 'WhatsApp', 'Sleeper', 'Email', 'Phone', 'Discord', and 'Carrier Pigeon' are currently supplied in the template
    },
    {
    ...
    },
    {
      ...
      "mode": "Win Now", // (optional) 'Win Now', 'Dynasty', or 'Rebuild' (anything else and you will need to add a new png to /static/ similar to the 'Rebuild.png' and 'Win Now.png' currently in there)
      "rival": {
        name: "Cam O'Brien", // Can be anything (usually your rival's name)
    ...
    },
    {
      ...
      "favoritePlayer": 8385, // (optional) this corresponds to the Sleeper player ID (https://api.sleeper.app/v1/players/nfl)
      "valuePosition": "RB", // (optional) Favorite position (QB, WR, RB, TE, etc.)
      "rookieOrVets": "Rookies", // (optional) 'Rookies' or 'Vets' (anything else and you will need to add a new png to /static/ similar to the 'Rookies.png' and 'Vets.png' currently in there)
      "philosophy": "Your fantasy team's philosophy",
      "tradingScale": 7, // 1 - 10
      ...
      "name": "Tyler Moody",
      "location": "Manchester, ME", // (optional)
      "bio": "@Chadballer92",
      "photo": "/managers/chadwick.jpg", // square ratio recommended (no larger than 500x500)
      "favoriteTeam": "ne", // (optional) favorite NFL team, (follows convention: nyj, sea, mia, etc.) MUST BE LOWERCASE
      "mode": "Win Now", // (optional) 'Win Now', 'Dynasty', or 'Rebuild' (anything else and you will need to add a new png to /static/ similar to the 'Rebuild.png' and 'Win Now.png' currently in there)
      "rival": {
        name: "Tyler Gosselin", // Can be anything (usually your rival's name)
    ...
    },
    {
      ...
      "location": "Winthrop, ME", // (optional)
      "bio": "@smithd5",
      "photo": "/managers/chand.jpg", // square ratio recommended (no larger than 500x500)
      "favoriteTeam": "ne", // (optional) favorite NFL team, (follows convention: nyj, sea, mia, etc.) MUST BE LOWERCASE
      "mode": "Win Now", // (optional) 'Win Now', 'Dynasty', or 'Rebuild' (anything else and you will need to add a new png to /static/ similar to the 'Rebuild.png' and 'Win Now.png' currently in there)
      "rival": {
        name: "Jake Lachance", // Can be anything (usually your rival's name)
    ...
    },
    {
      ...
      "name": "Zack Lampe",
      "location": "Portland, ME", // (optional)
      "bio": "@ShadesMcGrades (414)526-1389",
    ...
    },
    {
      ...
      "name": "Jake Lachance",
      "location": "Windham, ME", // (optional)
      "bio": "@jdlachance (207)242-3454",
      "photo": "/managers/jacob.jpg", // square ratio recommended (no larger than 500x500)
      "favoriteTeam": "ne", // (optional) favorite NFL team, (follows convention: nyj, sea, mia, etc.) MUST BE LOWERCASE
      "mode": "Win Now", // (optional) 'Win Now', 'Dynasty', or 'Rebuild' (anything else and you will need to add a new png to /static/ similar to the 'Rebuild.png' and 'Win Now.png' currently in there)
      "rival": {
        name: "Chandler Smith", // Can be anything (usually your rival's name)
        link: 11, // manager array number within this array, or null to link back to all managers page
        image: "/managers/chand.jpg", // either a specific manager photo or '/managers/everyone.png' or '/managers/question.png'
      },
